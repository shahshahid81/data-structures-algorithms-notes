...
int main()
{
    // Stores everything in sorted order and uniquely.
    ...
    // Remove 5 if found, else nothing. Note that this takes value not index, since this is a tree internally
    s.erase(5);

    // in case of set, count will always be 1 or 0 since elements are unique
    int cnt = s.count(1);
    cout << cnt << endl;
