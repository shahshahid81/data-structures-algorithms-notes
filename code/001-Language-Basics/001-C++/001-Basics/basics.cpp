...
void raw_array()
{
    ...
    // Array bounds are not checked, ensure to use correct indexes
    // cin >> vowels[5];
...
void std_array()
{
    ...
    *ptr = 10000;
    ...
    std::array<int, 10> arr3{1, 2, 3, 50, 60, 70, 80, 200, 300, 400};
    count = std::count_if(arr3.begin(), arr3.end(), [](int x)
                          { return x > 10 && x < 200; });
